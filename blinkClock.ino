...
const float RELAY_PUSH_1 = 0.25;
const float RELAY_PUSH_2 = 0.50;
const float RELAY_PUSH_3 = 1.00;
const float RELAY_PUSH_4 = 1.50;
const float RELAY_PUSH_5 = 2.00;
const float RELAY_PUSH_6 = 2.50;
const float RELAY_PUSH_7 = 3.00;
const float RELAY_PUSH_8 = 0.50;

// Channel Signal Pull Constants
const float RELAY_PULL_1 = 0.25;
const float RELAY_PULL_2 = 0.50;
const float RELAY_PULL_3 = 0.50;
const float RELAY_PULL_4 = 0.50;
const float RELAY_PULL_5 = 0.50;
const float RELAY_PULL_6 = 0.50;
const float RELAY_PULL_7 = 0.50;
const float RELAY_PULL_8 = 1.50;
